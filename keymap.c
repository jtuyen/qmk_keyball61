...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [MAC_BASE] = LAYOUT_universal(
    ...
    KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,MT(MOD_MEH,KC_ESC),KC_LGUI,QK_LEAD,KC_ENT,TT(2),MO(1),KC_SPC,KC_NO,KC_NO,KC_NO,KC_BTN2,KC_BTN1
  ),
  ...
  [WIN_BASE] = LAYOUT_universal(
    ...
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, LCTL_T(KC_SPC), LALT_T(KC_MINS), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS,
    KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, MT(MOD_MEH,KC_ESC), KC_LGUI, QK_LEAD, KC_ENT, TT(5), MO(4), KC_SPC, KC_NO, KC_NO, KC_NO, KC_BTN2, KC_BTN1
  ),
  ...
  [WIN_NAVIGATION] = LAYOUT_universal(
    SSNP_FRE,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_TRNS,
    SSNP_VRT, KC_NO, KC_NO, LGUI(KC_E), LCTL(KC_F5), LSG(KC_RIGHT), LALT(KC_LEFT), LCTL(KC_TAB), LALT(KC_RIGHT), KC_END, KC_NO, KC_BSPC,
  ...
  [OPTIONS] = LAYOUT_universal(
    ...
    INSOMNIA, RGB_TOG, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, INSOMNIA
  ),
