...
tap_dance_action_t tap_dance_actions[] = {
    [TD_MEDIA_NEXT] = ACTION_TAP_DANCE_DOUBLE(KC_MFFD, KC_AUDIO_VOL_UP),
    [TD_MEDIA_PREV] = ACTION_TAP_DANCE_DOUBLE(KC_MRWD, KC_AUDIO_VOL_DOWN),
};
...
const uint16_t PROGMEM winmac_lwr_rse_combo[] = {KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [WINMAC_LWR_RSE_MUTE] = COMBO(winmac_lwr_rse_combo, KC_AUDIO_MUTE),
